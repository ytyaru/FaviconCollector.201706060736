$(function(){
    ...
    cursor_index = 0
    $('#Icons').children()[cursor_index].focus();
...
//        if (0 == $('#Icons').children().length) { return 0; }
//        return $('#Icons').width() / $('#Icons a:first-child').width();
    }
    /*
    ...
    */
    ...
    /*
    // ウインドウサイズに応じてカーソルインデックスも変更せねばならない
...
//                if (cursor_index + line_num > $('#Icons').children().length - 1) { cursor_index = $('#Icons').children().length - 1; } else { cursor_index += line_num; }
//                if (cursor_index == $('#Icons').children().length - 1) { cursor_index = 0; } else { cursor_index++; }
                console.log(cursor_index);
                console.log($('#Icons').children()[cursor_index].focus());
                break;
